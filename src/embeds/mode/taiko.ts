...
export function taikoFields(param: RecentEmbedParameters, embed: EmbedBuilder) {
    ...
    embed.addFields([
        ...
        {
            name: 'Hits',
            value: `{${score.statistics.count_300}/${score.statistics.count_100}/${score.statistics.count_miss}}`,
            inline: true
        },
        {
            name: 'PP if FC',
        ...
        {
            name: 'Hits',
            value: `{${param.total_objects - score.statistics.count_100}/${score.statistics.count_100}/${0}}`,
            inline: true
        },
        {
            name: `Map Info`,
...
export function taikoCompact(param: RecentEmbedParameters, embed: EmbedBuilder) {
